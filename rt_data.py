...
class DataView(QWidget):
    ...
    def print_table(self):
        ...
        printer.setOrientation(QtPrintSupport.QPrinter.Landscape)  # Set the printer to landscape mode
        printer.setPaperSize(QtPrintSupport.QPrinter.Letter)  # Set the paper size to Letter
