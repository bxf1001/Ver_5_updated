...
from PyQt6.QtWidgets import QApplication, QStyleFactory, QMainWindow, QWidget, QLabel, QLineEdit, QListWidget,QListWidgetItem, QPushButton, QHBoxLayout, QGridLayout, QProgressBar
import warnings
import uuid
...
class PhonePortal(QMainWindow): # Inherit from QMainWindow
    ...
    def __init__(self, *args, **kwargs): # Add *args and **kwargs
        ...
        self.search_button.setIcon(QIcon("search_icon.png")) # Set the icon for the search button
        ...
        self.add_button.setIcon(QIcon("add_icon.png")) # Set the icon for the add button
        self.btn_add_user = QPushButton('Add User', self) # Add User button
        self.btn_add_user.setIcon(QIcon("adduser_icon.png")) # Set the icon for the add user button
        self.btn_add_user.setIcon(QIcon("adduser_icon.png")) # Set the icon for the add user button
        ...
        self.swap_button.setIcon(QIcon("swap_icon.png"))
        ...
        self.abort_button.setIcon(QIcon("abort_icon.png"))
        self.reset_button = QPushButton("Reset", self)  # Reset button to reset the UI elements
        self.reset_button.setIcon(QIcon("reset_icon.png")) # Set the icon for the reset button
